                                        ...
                                        <tbody>
                                            @foreach($event as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('edit_event' . $value->id)}}" edit-id="<?php echo $value->id; ?>" class="back_color btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                                        <a data-id="<?php echo $value->id; ?>" data-url="delete_event" data-back="event" class="btn btn-sm btn-danger delete"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
