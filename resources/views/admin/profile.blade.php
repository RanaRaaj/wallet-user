                                            ...
                                            <div class="card-body">
                                                <form action="{{route('admin.update.profile')}}" method="post">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <input type="text" name="name" value="{{isset($authUser)?$authUser->name :"record not found"}}"
                                                    ...
                                                    <fieldset class="form-group">
                                                        <input type="email" name="email" value="{{isset($authUser)?$authUser->email :"record not found"}}"
