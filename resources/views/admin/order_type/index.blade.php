                    ...
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body card-dashboard">
                                <button class="btn-info"><a href="{{url('create_order_type')}}" style="color: #fff;">Create New Order Type</a></button>
                                <p class="card-text">
                                                    </p>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($order as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('edit_order_type' . $value->id)}}" edit-id="<?php echo $value->id; ?>" class="back_color btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                                        <a data-id="<?php echo $value->id; ?>" data-url="delete_order_type" data-back="order_type" class="btn btn-sm btn-danger delete"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $count++ ?>
                                            @endforeach
